...
# specification of the plot to be plotted onto the stripes
...
Again, we make plots for the individual columns bit notice that some empty titles are added. This is to make the individual columns align when patching. We also bring back a transparent x-axis on all columns for the same reason.
